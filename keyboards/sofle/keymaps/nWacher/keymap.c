 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LGUI | LALT |LOWER | /Enter  /       \Space \  |RAISE | Bspc | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_DVORAK] = LAYOUT( \
  ...
  KC_LSFT,  KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X, KC_MUTE,     KC_HOME, KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,  KC_RSFT, \
                  KC_LGUI,KC_LGUI,KC_LALT,KC_LOWER, KC_ENT,       KC_SPC,  KC_RAISE, KC_BSPC, KC_RALT, KC_RGUI \
),
/*
 * QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Space  /       \Space \  |RAISE | Bspc | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_HOME, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                    KC_LGUI,KC_LGUI,KC_LALT,KC_LOWER, KC_SPC,    KC_ENT,  KC_RAISE, KC_BSPC, KC_RALT, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
  ...
  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,       _______, KC_LBRC, KC_RBRC, KC_BSLS, KC_COLN, KC_SCLN, KC_PIPE, \
